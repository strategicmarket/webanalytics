              ...
              <CardBlock className="card-body">
                ...
                <Table hover responsive className="table-outline mb-0 d-none d-sm-table">
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={avatarURL} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                    ...
                    <td className="text-center">
                      <img src={flagURL} alt="USA" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <img src={flagURL} alt="Brazil" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <img src={flagURL} alt="India" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <img src={flagURL} alt="France" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <img src={flagURL} alt="Spain" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <img src={flagURL} alt="Poland" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
