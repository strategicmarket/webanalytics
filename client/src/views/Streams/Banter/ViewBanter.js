...
class Dashboard extends Component {
  ...
  render() {
    ...
    return (
      ...
      <h3> Just heard from {username} </h3>
              ...
              <CardBlock className="card-body">
                ...
                <Table hover responsive className="table-outline mb-0 d-none d-sm-table">
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={"http://localhost:3001/img/avatars/1.jpg"} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                    ...
                    <td className="text-center">
                      <img src={'http://localhost:3001/img/flags/USA.png'} alt="USA" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={'http://localhost:3001/img/avatars/2.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                    ...
                    <td className="text-center">
                      <img src={'http://localhost:3001/img/flags/Brazil.png'} alt="Brazil" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={'http://localhost:3001/img/avatars/3.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                    ...
                    <td className="text-center">
                      <img src={'http://localhost:3001/img/flags/India.png'} alt="India" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={'http://localhost:3001/img/avatars/4.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                    ...
                    <td className="text-center">
                      <img src={'http://localhost:3001/img/flags/France.png'} alt="France" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={'http://localhost:3001/img/avatars/5.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                        <span className="avatar-status badge-success"></span>
                      </div>
                    </td>
                    <td>
                    ...
                    <td className="text-center">
                      <img src={'http://localhost:3001/img/flags/Spain.png'} alt="Spain" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="avatar">
                        <img src={'http://localhost:3001/img/avatars/6.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                        <span className="avatar-status badge-danger"></span>
                      </div>
                    </td>
                    <td>
                    ...
                    <td className="text-center">
                      <img src={'http://localhost:3001/img/flags/Poland.png'} alt="Poland" style={{height: 24 + 'px'}}/>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
